...
private:
	struct _Variable
	{
		QStringList BlockSendPacketList;
...
public:
	...
	void AddToBlockSendPacketList(const QString packet);
	void RemoveFromBlockSendPacketList(const QString packet);
	void ClearBlockSendPacketList();
